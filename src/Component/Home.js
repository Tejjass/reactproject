        ...
        <div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="text-primary" style={{fontWeight:"700", padding:"40px 0px 20px 40px"}}>01.</h4>
                        <h1 style={{ fontWeight: "700", padding: "20px 0px 20px 40px" }}>Business Setup</h1>
                        <p style={{ padding: "20px 0px 20px 40px" }}>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
                            dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip
                            ex ea commodo consequat. Duis aute irure dolor in reprehenderit.
                        </p>
                        <button type="button" id="btn1" class="btn btn-outline-primary" style={{ marginLeft: "40px" }}>Read More</button>
                    </div>
                </div>
                ...
                <div class="row" style={{ paddingTop: "80px" }}>
                    ...
                    <div class="col-md-6">
                        <h4 class="text-primary" style={{ fontWeight: "700", padding: "40px 0px 20px 40px" }}>03.</h4>
                        <h1 style={{ fontWeight: "700", padding: "20px 0px 20px 40px" }}>Audit And Assurance <br></br> Services</h1>
                        <p style={{ padding: "20px 0px 20px 40px" }}>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
                            dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip
                            ex ea commodo consequat. Duis aute irure dolor in reprehenderit.
                        </p>
                ...
                <div class="row" style={{ paddingTop: "80px" }}>
                    ...
                    <div class="col-md-6">
                        <h4 class="text-primary" style={{ fontWeight: "700", padding: "40px 0px 20px 40px" }}>05.</h4>
                        <h1 style={{ fontWeight: "700", padding: "20px 0px 20px 40px" }}>Financial Advisory And <br></br> Management Consultancy  </h1>
                        <p style={{ padding: "20px 0px 20px 40px" }}>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
                            dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip
                            ex ea commodo consequat. Duis aute irure dolor in reprehenderit.
                        </p>
